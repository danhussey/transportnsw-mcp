...
class DepartureMonitorResponseStopEvent(object):
    ...
    def __init__(self, departure_time_planned=None, infos=None, location=None, transportation=None, _configuration=None):  # noqa: E501
    ...
    @property
    def infos(self):
        """Gets the infos of this DepartureMonitorResponseStopEvent.  # noqa: E501

        Contains a number of service alert messages relating to this stop event. Information returned here is also available using the `add_info` API endpoint.   # noqa: E501

        :return: The infos of this DepartureMonitorResponseStopEvent.  # noqa: E501
    ...
    def infos(self, infos):
        """Sets the infos of this DepartureMonitorResponseStopEvent.

        Contains a number of service alert messages relating to this stop event. Information returned here is also available using the `add_info` API endpoint.   # noqa: E501

        :param infos: The infos of this DepartureMonitorResponseStopEvent.  # noqa: E501
