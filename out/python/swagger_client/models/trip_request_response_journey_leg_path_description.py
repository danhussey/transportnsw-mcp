...
class TripRequestResponseJourneyLegPathDescription(object):
    ...
    def __init__(self, coord=None, cum_distance=None, cum_duration=None, distance=None, distance_down=None, distance_up=None, duration=None, from_coords_index=None, manoeuvre=None, name=None, sky_direction=None, to_coords_index=None, turn_direction=None, _configuration=None):  # noqa: E501
