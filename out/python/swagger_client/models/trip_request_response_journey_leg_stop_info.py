...
class TripRequestResponseJourneyLegStopInfo(object):
    ...
    def __init__(self, content=None, id=None, priority=None, subtitle=None, timestamps=None, url=None, url_text=None, version=None, _configuration=None):  # noqa: E501
    ...
    def id(self):
        ...
        This is a unique identifier for this particular service alert. Note that this same ID is used in `add_info` for the same alert.   # noqa: E501
    ...
    def url(self):
        ...
        This field contains a URL that contains additional information about the alert. This value is equivalent to the `infoLinkURL` value in `add_info`.   # noqa: E501
    ...
    def url_text(self):
        ...
        This field contains a title that can be used when displaying the `url` URL. This value is equivalent to the `infoLinkText` value in `add_info`.   # noqa: E501
