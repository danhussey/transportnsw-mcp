...
class TripRequestResponseJourneyLegStop(object):
    ...
    def __init__(self, arrival_time_estimated=None, arrival_time_planned=None, coord=None, departure_time_estimated=None, departure_time_planned=None, disassembled_name=None, id=None, name=None, parent=None, properties=None, type=None, _configuration=None):  # noqa: E501
