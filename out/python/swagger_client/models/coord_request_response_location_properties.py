...
class CoordRequestResponseLocationProperties(object):
    ...
    def __init__(self, gis_draw_class=None, gis_draw_class_type=None, gis_niveau=None, poi_draw_class=None, poi_draw_class_type=None, poi_hierarchy_0=None, poi_hierarchy_key=None, distance=None, _configuration=None):  # noqa: E501
