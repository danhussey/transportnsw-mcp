...
class AdditionalInfoResponseMessage(object):
    ...
    def __init__(self, affected=None, content=None, id=None, priority=None, properties=None, subtitle=None, timestamps=None, type=None, url=None, url_text=None, version=None, _configuration=None):  # noqa: E501
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["routeInfo", "stopInfo", "lineInfo", "bannerInfo", "stopBlocking"]  # noqa: E501
        if (self._configuration.client_side_validation and
