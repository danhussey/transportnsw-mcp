...
class AdditionalInfoResponseAffectedStop(object):
    ...
    def __init__(self, id=None, name=None, parent=None, type=None, _configuration=None):  # noqa: E501
    ...
    def id(self):
        ...
        This the unique ID of the stop that is affected. It is the same ID that is used elsewhere in the system, such as in `trip` or `stop_finder`.   # noqa: E501
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["poi", "singlehouse", "stop", "platform", "street", "locality", "suburb", "gisPoint", "unknown"]  # noqa: E501
