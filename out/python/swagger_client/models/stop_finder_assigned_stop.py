...
class StopFinderAssignedStop(object):
    ...
    def __init__(self, connecting_mode=None, coord=None, disassembled_name=None, distance=None, duration=None, id=None, modes=None, name=None, parent=None, type=None, _configuration=None):  # noqa: E501
